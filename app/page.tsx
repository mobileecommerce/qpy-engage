...
type WidgetConversationSummary={sessionId:string;messageCount:number;lastMessage:string;lastRole:string;firstAt:string;lastAt:string;aiActive:boolean;customerName?:string|null;leadStatus?:string|null};
